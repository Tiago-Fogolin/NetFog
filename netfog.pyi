...
class Graph:
    ...
    @staticmethod
    def from_openalex(api_key: str, graph_type: OpenAlexGraphType, search=None, author=None, author_id=None, author_orcid=None, keyword=None, limit=None, min_weight=None, save_json_path=None) -> "Graph": ...
